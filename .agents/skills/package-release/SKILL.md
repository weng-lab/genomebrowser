...
4. Prepare package-specific notes and GitHub drafts within the requested scope. Follow [contribution guidance](../../../docs/02-contributing/README.md) for requested commits or PRs. Use structured text arguments or a notes file for multiline release bodies.
