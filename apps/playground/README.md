...
The home page at `/` shows an mm10 browser with one GENCODE M25 comprehensive Gene track. Pan by dragging, use the zoom buttons, and open track settings to change the display or switch to the basic annotation variant.
