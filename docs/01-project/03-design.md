...
The UI package provides controls for embedding applications. The standalone app may reuse them or build its own interface. Follow [feature placement](02-feature-placement.md) when deciding where a component belongs.
