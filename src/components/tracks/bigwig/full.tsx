...
export default function FullBigWig(props: BigWigProps) {
  ...
  return (
    <g width={trackWidth} height={props.height} clipPath={`url(#${props.id})`}>
      <rect width={trackWidth} height={props.height} fill={"white"} onMouseOut={mouseOut} />
      <defs>
