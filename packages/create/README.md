...
The generated app includes a browser, first-party track modules, a starter track collection, and TrackSelect. TrackSelect uses MUI X Premium; provide a license key through `VITE_MUI_X_LICENSE_KEY` if your use requires one.
