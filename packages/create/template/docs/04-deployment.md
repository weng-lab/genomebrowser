...
To run the app or test a build over SSH first, see [Run, build, and access remotely](01-running.md).
...
BigWig and BigBed access requires byte-range requests with uncompressed partial responses. A different data origin must allow cross-origin requests through CORS. See `node_modules/@weng-lab/genomebrowser-tracks/docs/04-troubleshooting.md` for diagnostics.
