...
This chapter builds on [Add and configure tracks](02-configureTracks.md), moving the two hg38 signal tracks into a collection. Both loading paths use the existing browser store and registered modules.
...
- [Collections and schemas](../03-reference/05-collectionsAndSchemas/README.md): catalog fields, metadata, validation, and editor tooling.
- [State and browser lifetime](../02-guides/stateAndLifetime.md): initialization, shared views, and state ownership.
- [Create a custom track](../02-guides/customTracks.md): defining additional module types for the same registry.
