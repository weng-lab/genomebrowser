...
Replace `YOUR_URL_HERE` with your data URL. Pass `tracks` to a [track store](../01-browserSetup/trackStore.md) to activate them. See [TrackCollection](trackCollection.md) for the complete input contract.
