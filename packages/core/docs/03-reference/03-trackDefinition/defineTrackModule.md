...
Register the module and add the instance to a [track store](../01-browserSetup/trackStore.md). The module's fetch function can return data without making a network request, as above.
...
- [Track renderers](../04-rendererIntegration/trackRenderer.md): SVG props and coordinate systems.
- [Track settings](trackSettings.md): forms and validated mutation callbacks.
- [Interactions](../04-rendererIntegration/useInteraction.md) and [tooltips](../04-rendererIntegration/useTooltip.md): typed items and current runtime context.
