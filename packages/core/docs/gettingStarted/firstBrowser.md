...
Application controls use the stores created by the application. Reusable renderers, settings forms, and tooltips obtain their hosting stores through [useGenomeBrowser](../reference/browserSetup/useGenomeBrowser.md), then use the returned hooks with selectors in the same way.
...
- [Track store](../reference/browserSetup/trackStore.md): adding tracks, updating settings, and changing display order.
- [Browser navigation](../reference/browserSetup/browserStore.md#navigation): changing the visible region through store actions.
- [Sizing and magnification](../reference/browserSetup/GenomeBrowser.md#examples): fixed drawing widths and scaling text and controls.
