...
- [Fetching data reference](../reference/trackDefinition/fetchingData.md): exact context fields, resources, and request lifetime.
- [fetchOnChange](../reference/trackDefinition/fetchOnChange.md): schema traversal and marker placement.
- [Track renderers](../reference/rendererIntegration/trackRenderer.md): rendering props and visible-region calculations.
