...
import type { SettingsModalProps, SettingsPosition, SettingsStoreInput } from "../settings/types";
...
export type SettingsStore = {
  ...
  setBaseSettingsComponent: (component: ComponentType) => void;
};
...
export type { SettingsModalProps, SettingsPosition, SettingsStoreInput } from "../settings/types";
