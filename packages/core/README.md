...
Add `@weng-lab/genomebrowser-tracks@beta` for the curated BigBed, BigWig, BulkBed, CAVE, cCRE BigBed, MethylC, and Gene modules. Core does not export first-party track implementations.
