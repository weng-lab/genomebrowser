...
The reference gene track reads `http://127.0.0.1:8765/gencode.v40.basic.annotation.bb`. Serve that file with byte-range and cross-origin request support before running the app.
