...
The reference gene track reads `https://users.wenglab.org/mezaj/gencode.v40.basic.annotation.bb`. The server must support byte-range and cross-origin requests.
