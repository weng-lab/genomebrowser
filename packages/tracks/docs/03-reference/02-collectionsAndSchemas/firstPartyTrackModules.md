...
`firstPartyTrackModules` is a readonly tuple with the nine modules in this order: Ruler, BigBed, BigWig, BulkBed, CAVE, cCRE BigBed, Gene, MethylC, BAM.
