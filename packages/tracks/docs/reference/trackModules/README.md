...
For URL-backed files, see [Data source troubleshooting](../../legacy/dataSources.md) when a source does not load.
...
[Create and validate tracks](trackCreation.md) covers registration, creation input, and schemas shared by all first-party modules. Import individual modules from their track subpaths, or use [firstPartyTrackModules](../collectionsAndSchemas/firstPartyTrackModules.md) to register all eight.
