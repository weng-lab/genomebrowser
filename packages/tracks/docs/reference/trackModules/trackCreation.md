...
Use [firstPartyTrackModules](../collectionsAndSchemas/firstPartyTrackModules.md) to register every built-in type. For a complete browser setup, see [Use first-party tracks](../../gettingStarted/useTracks.md).
