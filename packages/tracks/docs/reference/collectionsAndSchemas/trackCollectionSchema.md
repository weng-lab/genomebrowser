...
This is a JSON asset, not a JavaScript function. It provides editor validation; runtime collection validation remains the responsibility of `validateTrackCollection` from core with the same module list.
