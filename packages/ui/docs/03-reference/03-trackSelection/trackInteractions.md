...
Pass `resolveTrackInteraction` to TrackSelect. Use item and config types matching the selected module, or narrow unknown values in callbacks. See the [integration guide](../../02-guides/trackInteractions.md) for heterogeneous collections.
