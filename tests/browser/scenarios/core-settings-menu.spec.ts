...
test("settings edit the selected track, scroll, drag, resize and close", async ({ page }) => {
  ...
  await test.step("Open settings from the keyboard and edit only track B", async () => {
  ...
  await test.step("Reach the last setting without losing the draggable header", async () => {
  ...
  await test.step("Keep settings reachable after resizing, then close and switch tracks", async () => {
